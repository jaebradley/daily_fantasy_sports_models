...
from draft_kings.nba.models.contests.salary_cap.classic.lineup import Lineup, DuplicatePlayerError, InvalidPlayerPosition
...
class TestLineup(TestCase):
    ...
    def test_invalid_point_guard_position(self):
        with self.assertRaises(InvalidPlayerPosition):
            Lineup(
                point_guard=PlayerPoolPlayer(
                    player=Player(
                        id="1",
